...
def pause_timer():
    ...
    is_paused = True
    window.after_cancel(timer)
    paused_time = count_remaining_time()

# Function to calculate the remaining time
def count_remaining_time():
